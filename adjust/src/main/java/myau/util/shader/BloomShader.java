...
import myau.util.render.StencilUtil;
...
public class BloomShader {
    ...
    public static void renderBloom(int framebufferTexture, int iterations, int offset) {
        renderBloom(framebufferTexture, iterations, offset, null);
    }

    public static void renderBloomOutside(int framebufferTexture, int iterations, int offset, Runnable outsideMask) {
        renderBloom(framebufferTexture, iterations, offset, outsideMask);
    }

    private static void renderBloom(int framebufferTexture, int iterations, int offset, Runnable outsideMask) {
        ...
        boolean clipped = outsideMask != null;
        if (clipped) {
